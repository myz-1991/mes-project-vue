<template>
  <div class="app-container">
          ...
          <el-form :model="searchFormData" size="small">
            <el-row>
              <el-col :span="24">
                <el-form-item label="">
                  <el-col :span="16">
                    <el-input type="text" v-model="searchFormData.searchTextValue" placeholder="部門编码或名称查询"
                      @keyup.enter.native="orgTableSearch()"></el-input>
                  </el-col>
          ...
          <el-form :model="dataForm" @keyup.enter.native="getDataList()">
            <el-row>
              ...
              <el-col :offset="8" :span="8">
                <el-form-item label="">
                  <el-col :span="18">
                    <el-input type="text" size="small" v-model="dataForm.key" placeholder="设备编码或名称查询"
            ...
            <el-table-column align="center" label="操作" width="100" fixed="right">
              <template slot-scope="scope">
                <el-button size="small" icon="el-icon-edit" type="primary" @click="addOrUpdateHandle('2', scope.row.mateId)"
                  circle></el-button>
                <el-button size="small" icon="el-icon-delete" type="danger" @click="deleteHandle(scope.row.mateId)"
                  circle></el-button>
              </template>
            </el-table-column>
          </el-table>
    ...
    <equipmentAddOrUpdate v-if="addOrUpdateVisible" ref="equipmentAddOrUpdate" @refreshDataList="getDataList"></equipmentAddOrUpdate>
  </div>
</template>
