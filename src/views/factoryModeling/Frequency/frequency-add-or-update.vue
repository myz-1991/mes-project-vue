<template>
	<el-dialog :title="titleText" :close-on-click-modal="false" :visible.sync="visible">
		<el-form :model="dataForm" size="small" ref="dataForm" label-width="80px">
			<el-row>
				<el-col :span="12">
					<el-form-item label="名称" prop="mateName">
						<el-input v-model="dataForm.mateName" placeholder="名称"></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="12">
					<el-form-item label="班次数量" prop="mateSource">
			...
			<el-row>
				<el-col :span="12">
					<el-form-item label="开始日期" prop="mateType">
				...
				<el-col :span="12">
					<el-form-item label="结束日期" prop="mateUnit">
			...
			<el-row>
				<el-col :span="12">
					<el-form-item label="开始时间" prop="startTime1">
						<el-time-select placeholder="开始时间" style="width: 100%;" v-model="dataForm.startTime1" :picker-options="{
				        start: '00:00',
				        step: '01:00',
				        end: '23:00'
				      }">
				...
				<el-col :span="12">
					<el-form-item label="结束时间" prop="endTime1">
						<el-time-select placeholder="结束时间" style="width: 100%;" v-model="dataForm.endTime1" :picker-options="{
				      start: '00:00',
				      step: '00:30',
				      end: '23:00'
				    }">
			...
			<el-row>
				<el-col :span="12">
					<el-form-item label="开始时间" prop="startTime2">
						<el-time-select placeholder="开始时间" style="width: 100%;" v-model="dataForm.startTime2" :picker-options="{
				        start: '00:00',
				        step: '01:00',
				        end: '23:00'
				      }">
				...
				<el-col :span="12">
					<el-form-item label="结束时间" prop="endTime2">
						<el-time-select placeholder="结束时间" style="width: 100%;" v-model="dataForm.endTime2" :picker-options="{
				      start: '00:00',
				      step: '00:30',
				      end: '23:00'
				    }">
			...
			<el-row>
				<el-col :span="12">
					<el-form-item label="开始时间" prop="startTime3">
						<el-time-select placeholder="开始时间" style="width: 100%;" v-model="dataForm.startTime3" :picker-options="{
				        start: '00:00',
				        step: '01:00',
				        end: '23:00'
				      }">
				...
				<el-col :span="12">
					<el-form-item label="结束时间" prop="endTime3">
						<el-time-select placeholder="结束时间" style="width: 100%;" v-model="dataForm.endTime3" :picker-options="{
				      start: '00:00',
				      step: '00:30',
				      end: '23:00'
				    }">
