  ...
  <div>
    ...
    >
      ...
      <template v-for="(item,index) in tableHead">
        <el-table-column :key="index" :prop="'\\' + item.采集点名称" :label="item.采集项名称" />
      </template>
...
<script>
import { findTypeValues, getEquipmentName, getEquipmentCollectionPoint, getCYJTableTitle, getCYJ } from '@/api/a/a'
export default {
  data() {
    return {
      tableHead: [],
