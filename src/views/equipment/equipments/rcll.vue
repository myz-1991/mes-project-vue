    ...
    >
      ...
      <div class="col-md-12" style="width: 100%; padding: 10px">
        <div style="display: flex">
          <div style="flex: 2 1 0%">固溶预热区当前温度:</div>
          <div class="lineData">
            {{ item.固溶预热区当前温度 }}
          </div>
          <div style="flex: 2 1 0%">固溶预热区设定温度:</div>
          <div class="lineData">
            {{ item.固溶预热区设定温度 }}
          </div>
          <div style="flex: 2 1 0%">固溶1区当前温度:</div>
          <div class="lineData">
            {{ item.固溶1区当前温度 }}
          </div>
          <div style="flex: 2 1 0%">固溶2区当前温度:</div>
          <div class="lineData">
            {{ item.固溶2区当前温度 }}
          </div>
          <div style="flex: 2 1 0%">固溶3区当前温度:</div>
          <div class="lineData">
            {{ item.固溶3区当前温度 }}
          </div>
        </div>
      ...
      <div class="col-md-12" style="width: 100%; padding: 10px">
        <div style="display: flex">
          <div style="flex: 2 1 0%">固溶4区当前温度:</div>
          <div class="lineData">
            {{ item.固溶4区当前温度 }}
          </div>
          <div style="flex: 2 1 0%">固溶5区当前温度:</div>
          <div class="lineData">
            {{ item.固溶5区当前温度 }}
          </div>
          <div style="flex: 2 1 0%">固溶6区当前温度:</div>
          <div class="lineData">
            {{ item.固溶6区当前温度 }}
          </div>
          <div style="flex: 2 1 0%">固溶7区当前温度:</div>
          <div class="lineData">
            {{ item.固溶7区当前温度 }}
          </div>
          <div style="flex: 2 1 0%">固溶8区当前温度:</div>
          <div class="lineData">
            {{ item.固溶8区当前温度 }}
          </div>
        </div>
      ...
      <div class="col-md-12" style="width: 100%; padding: 10px">
        <div style="display: flex">
          <div style="flex: 2 1 0%">固溶1区设定温度:</div>
          <div class="lineData">
            {{ item.固溶1区设定温度 }}
          </div>
          <div style="flex: 2 1 0%">固溶2区设定温度:</div>
          <div class="lineData">
            {{ item.固溶2区设定温度 }}
          </div>
          <div style="flex: 2 1 0%">固溶3区设定温度:</div>
          <div class="lineData">
            {{ item.固溶3区设定温度 }}
          </div>
          <div style="flex: 2 1 0%">固溶4区设定温度:</div>
          <div class="lineData">
            {{ item.固溶4区设定温度 }}
          </div>
          <div style="flex: 2 1 0%">固溶5区设定温度:</div>
          <div class="lineData">
            {{ item.固溶5区设定温度 }}
          </div>
        </div>
      ...
      <div class="col-md-12" style="width: 100%; padding: 10px">
        <div style="display: flex">
          <div style="flex: 2 1 0%">固溶6区设定温度:</div>
          <div class="lineData">
            {{ item.固溶6区设定温度 }}
          </div>
          <div style="flex: 2 1 0%">固溶7区设定温度:</div>
          <div class="lineData">
            {{ item.固溶7区设定温度 }}
          </div>
          <div style="flex: 2 1 0%">固溶8区设定温度:</div>
          <div class="lineData">
            {{ item.固溶8区设定温度 }}
          </div>
          <div style="flex: 2 1 0%">淬火水槽当前温度:</div>
          <div class="lineData">
            {{ item.淬火水槽当前温度 }}
          </div>
          <div style="flex: 2 1 0%">淬火水槽设定温度:</div>
          <div class="lineData">
            {{ item.淬火水槽设定温度 }}
          </div>
        </div>
      ...
      <div class="col-md-12" style="width: 100%; padding: 10px">
        <div style="display: flex">
          <div style="flex: 2 1 0%">时效1当前温度:</div>
          <div class="lineData">
            {{ item.时效1当前温度 }}
          </div>
          <div style="flex: 2 1 0%">时效1设定温度:</div>
          <div class="lineData">
            {{ item.时效1设定温度 }}
          </div>
          <div style="flex: 2 1 0%">时效2当前温度:</div>
          <div class="lineData">
            {{ item.时效2当前温度 }}
          </div>
          <div style="flex: 2 1 0%">时效2设定温度:</div>
          <div class="lineData">
            {{ item.时效2设定温度 }}
          </div>
          <div style="flex: 2 1 0%">固溶1区烧嘴指示1:</div>
          <div class="lineData">
            {{ item.固溶1区烧嘴指示1 }}
          </div>
        </div>
      ...
      <div class="col-md-12" style="width: 100%; padding: 10px">
        <div style="display: flex">
          <div style="flex: 2 1 0%">固溶1区烧嘴指示2:</div>
          <div class="lineData">
            {{ item.固溶1区烧嘴指示2 }}
          </div>
          <div style="flex: 2 1 0%">固溶2区烧嘴指示:</div>
          <div class="lineData">
            {{ item.固溶2区烧嘴指示 }}
          </div>
          <div style="flex: 2 1 0%">固溶3区烧嘴指示:</div>
          <div class="lineData">
            {{ item.固溶3区烧嘴指示 }}
          </div>
          <div style="flex: 2 1 0%">固溶4区烧嘴指示:</div>
          <div class="lineData">
            {{ item.固溶4区烧嘴指示 }}
          </div>
          <div style="flex: 2 1 0%">固溶5区烧嘴指示:</div>
          <div class="lineData">
            {{ item.固溶5区烧嘴指示 }}
          </div>
        </div>
      ...
      <div class="col-md-12" style="width: 100%; padding: 10px">
        <div style="display: flex">
          <div style="flex: 2 1 0%">固溶6区烧嘴指示:</div>
          <div class="lineData">
            {{ item.固溶6区烧嘴指示 }}
          </div>
          <div style="flex: 2 1 0%">固溶7区烧嘴指示:</div>
          <div class="lineData">
            {{ item.固溶7区烧嘴指示 }}
          </div>
          <div style="flex: 2 1 0%">固溶8区烧嘴指示:</div>
          <div class="lineData">
            {{ item.固溶8区烧嘴指示 }}
          </div>
          <div style="flex: 2 1 0%">时效1区烧嘴指示:</div>
          <div class="lineData">
            {{ item.时效1区烧嘴指示 }}
          </div>
          <div style="flex: 2 1 0%">时效2区烧嘴指示:</div>
          <div class="lineData">
            {{ item.时效2区烧嘴指示 }}
          </div>
        </div>
      ...
      <div class="col-md-12" style="width: 100%; padding: 10px">
        <div style="display: flex">
          <div style="flex: 2 1 0%">炉前门关门状态:</div>
          <div class="lineData">
            {{ item.炉前门关门状态 }}
          </div>
...
export default {
  ...
  methods: {
    ...
    loadData() {
      ...
      // });
      findTypeValues("热处理炉").then((respone) => {
