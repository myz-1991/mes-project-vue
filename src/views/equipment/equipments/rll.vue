   ...
   <div
    ...
    >
      ...
      >
        ...
        <!-- <h3 class="box-title">熔炼</h3> -->
        <div class="eq_status" v-show="item.报警指示灯 === 'False'">
          <span style="color: white">运行</span>
        </div>
        <div class="eq_statusRed" v-show="item.报警指示灯 === 'True'">
          <span style="color: white">报警</span>
        </div>
      </div>
      <div class="col-md-12" style="width: 100%; padding: 10px">
        <div style="display: flex">
          <div style="flex: 2 1 0%">铝液温度:</div>
          <div
            style="
              text-align: right;
              flex: 1 1 0%;
      ...
      <div class="col-md-12" style="width: 100%; padding: 10px">
        <div style="display: flex">
          ...
          <div style="flex: 2 1 0%">铝液温度设定:</div>
          <div
            style="
              text-align: right;
              flex: 1 1 0%;
      ...
      <div class="col-md-12" style="width: 100%; padding: 10px">
        <div style="display: flex">
          <div style="flex: 2 1 0%">炉气温度设定:</div>
          <div
            style="
              text-align: right;
              flex: 1 1 0%;
          ...
          <div style="flex: 2 1 0%">排气温度设定:</div>
          <div
            style="
              text-align: right;
              flex: 1 1 0%;
      ...
      <div class="col-md-12" style="width: 100%; padding: 10px">
        <div style="display: flex">
          ...
          <div style="flex: 2 1 0%">铝液上上线:</div>
          <div
            style="
              text-align: right;
              flex: 1 1 0%;
      ...
      <div class="col-md-12" style="width: 100%; padding: 10px">
        <div style="display: flex">
          <div style="flex: 2 1 0%">出铝次数统计:</div>
          <div
            style="
              text-align: right;
              flex: 1 1 0%;
          ...
          <div style="flex: 2 1 0%">报警指示灯:</div>
          <div
            style="
              text-align: right;
              flex: 1 1 0%;
      ...
      <div class="col-md-12" style="width: 100%; padding: 10px">
        <div style="display: flex">
          <div style="flex: 2 1 0%">上料指示灯:</div>
          <div
            style="
              text-align: right;
              flex: 1 1 0%;
          ...
          <div style="flex: 2 1 0%">运行停止状态:</div>
          <div
            style="
              text-align: right;
              flex: 1 1 0%;
      ...
      <!-- id="myTempo" -->
      <!-- <div class="myTempo" :id="item.id" :style="{width: '400px', height: '230px'}"></div> -->
    </div>
...
export default {
  ...
  methods: {
    ...
    loadData() {
      ...
      // });
      findTypeValues("熔炼炉").then((respone) => {
