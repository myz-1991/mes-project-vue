	...
	<div class="app-container">
		<el-row>
			<el-col :span="24">
				<el-row>
					<el-form :model="dataForm" size="small">
						<el-row>
							<el-col :span="8">
								<el-form-item label="">
									<el-button type="primary" icon="el-icon-refresh" @click="refreshUserTable()" round>刷新</el-button>
							...
							<el-col :offset="8" :span="8">
								<el-form-item label="">
									<el-col :span="18">
										<el-input type="text" v-model="dataForm.searchTextValue" @keyup.enter.native="refreshUserTable()"></el-input>
									</el-col>
									<el-col :offset="1" :span="3">
										<el-button type="primary" icon="el-icon-search" @click="refreshUserTable()" round>查询</el-button>
									</el-col>
								</el-form-item>
							</el-col>
						</el-row>
				...
				<el-row>
					<el-table :data="dataList" size="small" border v-loading="dataListLoading" style="width: 100%;">
		...
		<el-dialog :visible.sync="dialogVisible" :title="dialogType==='edit'?'用户修改':'用户添加'">
			<el-form :model="userDataForm" size="small" ref="dataForm" label-width="80px">
				<el-row>
					<el-col :span="12">
						<el-form-item label="姓名:" prop="name">
							<el-input v-model="userDataForm.name" placeholder="姓名" size="small"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="工号:" prop="code">
							<el-input v-model="userDataForm.code" placeholder="工号" size="small"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="用户名:" prop="userName">
							<el-input v-model="userDataForm.userName" placeholder="登录帐号" size="small"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="密码:" prop="passWord">
							<el-input v-model="userDataForm.passWord" type="password" placeholder="密码" size="small"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="邮箱:" prop="email">
							<el-input v-model="userDataForm.email" placeholder="邮箱" size="small"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="手机号:" prop="telephone">
							<el-input v-model="userDataForm.telephone" placeholder="手机号" size="small"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="所属组织:" prop="orgName">
							...
							<el-select-tree :value="userDataForm.orgName" size="small" style="width: 100%;" :selectOpt="option.select"
							 :treeOpt="option.tree" @node-click="clickNode">
					...
					<el-col :span="12">
						<el-form-item label="角色分配:" prop="roleSelect">
							<el-select v-model="userDataForm.roleNameSelect" placeholder="请选择" style="width: 100%;" size="small" multiple
			...
			<span slot="footer" class="dialog-footer" style="text-align:right;">
				<el-button type="danger" size="small" icon="el-icon-delete" @click="dialogVisible = false" round>取消</el-button>
