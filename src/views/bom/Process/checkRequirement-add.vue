  ...
  <el-dialog :title="titleText" :close-on-click-modal="false" :visible.sync="visible" width="50%">
    ...
    <el-table ref="processsTable" v-loading="dataListLoading" size="small" :data="dataList" border style="width: 100%">
      ...
      <el-table-column size="small" header-align="center" align="center" label="标准值" width="100">
        <template slot-scope="scope">
          <el-input v-show="scope.row.show" v-model="scope.row.itemStandardValue" size="small" placeholder="标准值" style="width: 100%;" />
      ...
      <el-table-column prop="mateSpecifications" header-align="center" align="center" label="正误差" width="100">
        <template slot-scope="scope">
          <el-input v-show="scope.row.show" v-model="scope.row.itemPositiveerror" size="small" placeholder="正误差" style="width: 100%;" />
      ...
      <el-table-column header-align="center" align="center" label="负误差" width="100">
        <template slot-scope="scope">
          <el-input v-show="scope.row.show" v-model="scope.row.itemNegativeerror" size="small" placeholder="负误差" style="width: 100%;" />
      ...
      <el-table-column header-align="center" align="center" label="尺寸" width="100">
        <template slot-scope="scope">
          <el-input v-show="scope.row.show" v-model="scope.row.itemSize" size="small" placeholder="尺寸" style="width: 100%;" />
