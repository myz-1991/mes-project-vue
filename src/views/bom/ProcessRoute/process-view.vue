  ...
  <el-dialog :title="titleText" :close-on-click-modal="false" :visible.sync="visible" width="80%">
    ...
    <el-table ref="processsTable" size="small" :data="dataList" border v-loading="dataListLoading" style="width: 100%">
      ...
      <el-table-column header-align="center" align="center" label="定额准备时间" width="120">
        <template slot-scope="scope">
          <el-input v-model="scope.row.procQuotaPreparetime" v-show="scope.row.show" size="small" placeholder="定额准备时间"
            style="width: 100%;"></el-input>
      ...
      <el-table-column header-align="center" align="center" label="是否重要工序" width="120">
        <template slot-scope="scope">
          <el-select v-model="scope.row.procImportantStutas" size="small" v-show="scope.row.show" placeholder="请选择"
            style="width: 100%;">
