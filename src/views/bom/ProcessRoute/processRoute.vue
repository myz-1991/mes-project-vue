      ...
      <el-table-column align="center" label="操作" width="150">
        <template slot-scope="scope">
          ...
          <el-tooltip class="item" effect="dark" content="设置工序" placement="top-start">
            <el-button size="mini" icon="el-icon-setting" type="success" @click="processViewOpen(scope.row)" circle></el-button>
          </el-tooltip>
  ...
  export default {
    ...
    methods: {
      ...
      processViewOpen(row) {
        ...
        this.$nextTick(() => {
          this.$refs.processView.init(row.id)
        })
      },
      // 删除
      deleteHandle(row) {
