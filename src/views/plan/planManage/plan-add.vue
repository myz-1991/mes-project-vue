	...
	<el-dialog :title="titleText" size="small" :close-on-click-modal="false" :visible.sync="visible" width="60%">
		<div v-show="showFlag === 1">
			<el-form ref="dataForm" :model="dataForm" size="small" label-width="120px">
				<el-row>
					<el-col :span="12">
						<el-form-item label="计划单号" prop="name">
							<el-input v-model="dataForm.name" placeholder="计划单号" readonly />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="订单编号" prop="code">
							<el-input v-model="dataForm.code" placeholder="订单编号" readonly />
						</el-form-item>
					</el-col>
				</el-row>
				<el-row>
					...
					<el-col :span="3" :offset="1">
						<el-link size="mini" type="success" style="margin-top: 5px;" @click="initProuduct">查询产品</el-link>
						<!-- <el-button type="primary" size="mini" icon="el-icon-search" round @click="taskTableSearch()">查询产品</el-button> -->
					</el-col>
				</el-row>
				<el-row>
					<el-col :span="12">
