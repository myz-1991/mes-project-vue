<template>
	<div class="app-container">
		<el-row>
			<el-form :model="searchFormData" size="small">
				<el-row>
					<el-col :span="16">
						<el-form-item label="">
							<el-button size="small" type="primary" icon="el-icon-refresh" round @click="refreshorgTable()">刷新</el-button>
							<el-button size="small" type="primary" icon="el-icon-plus" round @click="addOrUpdateHandle(1, 0)">新建计划</el-button>
							<el-button size="small" type="primary" icon="el-icon-plus" round @click="addOrUpdateHandle1(1, 0)">新建任务</el-button>
							<el-button size="small" type="primary" icon="el-icon-receiving" round @click="visible = true">导入</el-button>
						</el-form-item>
					</el-col>
					<el-col :span="8">
						<el-form-item label="">
			...
			<el-table ref="taskTable" :data="taskDataList" size="small" border>
				...
				<el-table-column prop="statusName" align="center" label="状态">
					<template slot-scope="scope">
						<el-tag v-if="tagType(scope.row.status) == 1" size="small" type="danger">未分配</el-tag>
						<el-tag v-else size="small">已分配</el-tag>
					</template>
				</el-table-column>
		...
		<taskView v-if="taskViewVisible" ref="taskView" @refreshDataList="refreshorgTable" />
