	...
	<div class="app-container">
		<el-row>
			<el-table size="mini" :data="dataList" border v-loading="dataListLoading" style="width: 100%;">
				...
				<el-table-column prop="itemStandardValue" align="center" label="规格">
				</el-table-column>
				<el-table-column prop="itemPositiveerror" align="center" label="适用产品">
				</el-table-column>
				<el-table-column prop="itemNegativeerror" align="center" label="批次">
				</el-table-column>
				<el-table-column prop="itemSize" align="center" label="供货商">
				</el-table-column>
				<el-table-column prop="itemSize" align="center" label="数量">
				</el-table-column>
