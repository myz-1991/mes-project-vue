	...
	<div class="app-container">
		<el-form :model="dataForm" inline>
			<el-row>
				...
				<el-col :span="3">
					<el-form-item>
						<el-select placeholder="请选择盘点类型" @change="storageChange">
							<el-option label="日常盘点" value="1"></el-option>
							<el-option label="月度盘点" value="2"></el-option>
							<el-option label="季度盘点" value="2"></el-option>
							<el-option label="年度盘点" value="2"></el-option>
						</el-select>
					</el-form-item>
				</el-col>
				<el-col :span="3">
					<el-form-item>
						<el-input placeholder="盘点单号"></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="3">
					<el-form-item>
		...
		<el-table :data="tableData" height="700" style="width: 100%;margin-bottom: 0px" border>
			...
			<el-table-column prop="code" align="center" label="期初数量">
			</el-table-column>
			<el-table-column prop="code" align="center" label="入库数量">
			</el-table-column>
			<el-table-column prop="code" align="center" label="出库数量">
			</el-table-column>
			<el-table-column prop="code" align="center" label="账面数量">
			</el-table-column>
			<el-table-column prop="code" align="center" label="结余数量">
			</el-table-column>
			<el-table-column prop="code" align="center" label="盈亏数量">
			</el-table-column>
		</el-table>
