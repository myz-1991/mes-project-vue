	...
	<div class="app-container">
		<el-form :model="dataForm" inline>
			<el-row>
				...
				<el-col :span="6">
					<el-form-item>
						<el-input v-model="searchText" icon="search" placeholder="扫码出库" style="width: 100%;" @change="realTime"></el-input>
					</el-form-item>
					<el-form-item>
				...
				<el-col :span="11" :offset="2">
					<el-form-item>
						<el-button v-if="buttonFlag == 1" size="mini" icon="el-icon-check" type="primary" @click="visible = true" round>出库</el-button>
						<el-button v-if="buttonFlag == 2" size="mini" icon="el-icon-check" type="primary" @click="visible = true" round>领用</el-button>
					</el-form-item>
				</el-col>
			</el-row>
		</el-form>
		<el-row>
			<el-col :span="11">
				<el-table :data="tableData" height="700" border style="width: 100%;margin-bottom: 0px" @selection-change="handleSelectionChange">
					...
					<el-table-column prop="designnumber" align="center" label="库存数量">
					</el-table-column>
					<el-table-column prop="designnumber" align="center" label="存储位置">
					</el-table-column>
					</el-table-column>
				</el-table>
			...
			<el-col :span="11">
				<el-table :data="resultData" height="700" style="width: 100%;margin-bottom: 0px" border>
					...
					<el-table-column prop="number" align="center" label="出库数量">
		...
		<el-dialog title="出库/领用" :visible.sync="visible" width="30%">
