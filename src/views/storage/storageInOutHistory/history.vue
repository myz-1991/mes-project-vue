	...
	<div class="app-container">
		<el-form :model="dataForm" inline>
			<el-row>
				...
				<el-col :span="3">
					<el-form-item>
						<el-input v-model="searchText" icon="search" placeholder="按单号查询" style="width: 100%;" @change="realTime"></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="3">
					<el-form-item>
						<el-date-picker placeholder="开始时间" style="width:100%;"></el-date-picker>
					</el-form-item>
				</el-col>
				<el-col :span="3">
					<el-form-item>
						<el-date-picker placeholder="结束时间"></el-date-picker>
					</el-form-item>
				</el-col>
			</el-row>
		</el-form>
		<el-table :data="tableData" height="750" style="width: 100%;margin-bottom: 0px" border>
			<el-table-column prop="code" align="center" label="单号">
			</el-table-column>
			<el-table-column prop="name" align="center" label="类型">
			</el-table-column>
			<el-table-column prop="specifications" align="center" label="经手人">
			</el-table-column>
			<el-table-column prop="designnumber" align="center" label="日期">
			</el-table-column>
			</el-table-column>
			<el-table-column label="操作">
				<template slot-scope="scope">
					<el-button size="mini" type="danger" @click="visible = true">查看明细</el-button>
				</template>
			</el-table-column>
		</el-table>
		...
		<el-dialog title="明细查看" :visible.sync="visible" width="50%">
			<el-table style="width: 100%;margin-bottom: 0px" border>
				...
				<el-table-column prop="designnumber" align="center" label="数量">
				</el-table-column>
				<el-table-column prop="designnumber" align="center" label="位置">
				</el-table-column>
			</el-table>
			<el-pagination @size-change="sizeChangeHandle" @current-change="currentChangeHandle" :current-page="pageIndex"
			 :page-sizes="[30, 60, 90, 120]" :page-size="pageSize" :total="totalPage" layout="total, sizes, prev, pager, next, jumper">
