<template>
  <div class="app-container">
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" size="small" style="width: 100%">
      ...
      <el-table-column prop="mateCode" header-align="center" align="center" label="模具编码">
      </el-table-column>
      <el-table-column prop="mateName" header-align="center" align="center" label="模具名称">
      </el-table-column>
      ...
      <el-table-column prop="mateSpecifications" header-align="center" align="center" label="额定寿命">
      </el-table-column>
      <el-table-column prop="mateSpecifications" header-align="center" align="center" label="寿命预警">
      </el-table-column>
