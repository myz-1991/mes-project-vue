<template>
  <el-dialog :title="titleText" :close-on-click-modal="false" :visible.sync="visible">
    <el-form ref="dataForm" :model="dataForm" size="small" label-width="80px">
      <el-row>
        <el-col :span="12">
          <el-form-item label="模具编码" prop="mateCode">
            <el-input v-model="dataForm.mateCode" placeholder="模具编码" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="模具名称" prop="mateName">
            <el-input v-model="dataForm.mateName" placeholder="模具名称" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item label="规格型号" prop="mateDesignNumber">
            <el-input v-model="dataForm.mateDesignNumber" placeholder="规格型号" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="精度" prop="mateSpecifications">
            <el-input v-model="dataForm.mateSpecifications" placeholder="精度" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item label="额定寿命" prop="mateBrand">
            <el-input v-model="dataForm.mateBrand" placeholder="额定寿命" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="寿命预警" prop="mateTexture">
            <el-input v-model="dataForm.mateTexture" placeholder="寿命预警" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item label="状态" prop="mateWeightUnit">
