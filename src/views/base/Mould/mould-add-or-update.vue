    ...
    <el-row>
      <el-col :span="12">
        <el-form-item label="模具编码" prop="mateCode">
          <el-input v-model="dataForm.mateCode" placeholder="模具编码"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item label="模具名称" prop="mateName">
          <el-input v-model="dataForm.mateName" placeholder="模具名称"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
    ...
    <el-row>
      <el-col :span="12">
        <el-form-item label="额定寿命" prop="mateBrand">
          <el-input v-model="dataForm.mateBrand" placeholder="额定寿命"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item label="寿命预警" prop="mateTexture">
          <el-input v-model="dataForm.mateTexture" placeholder="寿命预警"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
