<template>
  <div class="app-container">
    <el-form :model="dataForm" @keyup.enter.native="getDataList()">
      <el-row>
        ...
        <el-col :offset="8" :span="8">
          <el-form-item label="">
            <el-col :span="18">
              <el-input type="text" size="small" v-model="dataForm.key" placeholder="夹具编码或名称查询" @keyup.enter.native="getDataList()"></el-input>
            </el-col>
    ...
    <el-dialog title="夹具导入" size="small" :close-on-click-modal="false" :visible.sync="visible" width="75%">
...
<script>
  import { findClampPage, updateClamp, importClamps } from '@/api/base/clamp'
