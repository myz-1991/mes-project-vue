      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="刀具编码" prop="mateCode">
            <el-input v-model="dataForm.mateCode" placeholder="刀具编码" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="刀具名称" prop="mateName">
            <el-input v-model="dataForm.mateName" placeholder="刀具名称" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="刀具规格" prop="mateSpecifications">
            <el-input v-model="dataForm.mateSpecifications" placeholder="刀具规格" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
