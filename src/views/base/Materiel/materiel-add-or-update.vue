      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="物料编码" prop="mateCode">
            <el-input v-model="dataForm.mateCode" placeholder="物料编码" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="物料名称" prop="mateName">
            <el-input v-model="dataForm.mateName" placeholder="物料名称" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item label="物料图号" prop="mateDesignNumber">
            <el-input v-model="dataForm.mateDesignNumber" placeholder="物料图号" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="物料规格" prop="mateSpecifications">
            <el-input v-model="dataForm.mateSpecifications" placeholder="物料规格" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="物料牌号" prop="mateBrand">
            <el-input v-model="dataForm.mateBrand" placeholder="物料牌号" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="物料材质" prop="mateTexture">
            <el-input v-model="dataForm.mateTexture" placeholder="物料材质" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item label="物料净重" prop="mateNetWeight">
            <el-input v-model="dataForm.mateNetWeight" placeholder="物料净重" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="物料毛重" prop="mateGrossWeight">
            <el-input v-model="dataForm.mateGrossWeight" placeholder="物料毛重" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="物料炉号" prop="mateFurnaceNumber">
            <el-input v-model="dataForm.mateFurnaceNumber" placeholder="物料炉号" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
