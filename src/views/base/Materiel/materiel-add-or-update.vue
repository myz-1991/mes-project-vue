<template>
  <el-dialog :title="titleText" :close-on-click-modal="false" :visible.sync="visible">
    ...
    <el-row>
      <el-col :span="12">
        <el-form-item label="物料编码" prop="mateCode">
          <el-input v-model="dataForm.mateCode" placeholder="物料编码"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item label="物料名称" prop="mateName">
          <el-input v-model="dataForm.mateName" placeholder="物料名称"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="12">
        <el-form-item label="物料图号" prop="mateDesignNumber">
          <el-input v-model="dataForm.mateDesignNumber" placeholder="物料图号"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item label="物料规格" prop="mateSpecifications">
          <el-input v-model="dataForm.mateSpecifications" placeholder="物料规格"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
		<el-row>
		  <el-col :span="12">
		    <el-form-item label="物料类型" prop="mateType">
		  ...
		  <el-col :span="12">
		    <el-form-item label="计量单位" prop="mateUnit">
		...
		<el-row>
		  <el-col :span="12">
		    <el-form-item  label="来源" prop="mateSource">
		    <el-select v-model="dataForm.mateSource" placeholder="请选择" style="width: 100%;" @change="((val)=>{mateSourceChange(val, index)})">
        ...
        <el-form-item label="物料尺寸" prop="mateSize">
          <el-input v-model="dataForm.mateSize" placeholder="物料尺寸"></el-input>
        </el-form-item>
		  </el-col>
		</el-row>
    <el-row>
      <el-col :span="12">
        <el-form-item label="物料牌号" prop="mateBrand">
          <el-input v-model="dataForm.mateBrand" placeholder="物料牌号"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item label="物料材质" prop="mateTexture">
          <el-input v-model="dataForm.mateTexture" placeholder="物料材质"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="12">
        <el-form-item label="物料净重" prop="mateNetWeight">
          <el-input v-model="dataForm.mateNetWeight" placeholder="物料净重"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item label="物料毛重" prop="mateGrossWeight">
          <el-input v-model="dataForm.mateGrossWeight" placeholder="物料毛重"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="12">
        <el-form-item  label="重量单位" prop="mateWeightUnit">
        <el-select v-model="dataForm.mateWeightUnit" placeholder="请选择" style="width: 100%;" @change="((val)=>{mateWeightUnitChange(val, index)})">
      ...
      <el-col :span="12">
        <el-form-item label="辅助单位" prop="mateAuxiliaryUnit">
          <el-select v-model="dataForm.mateAuxiliaryUnit" placeholder="请选择" style="width: 100%;" @change="((val)=>{mateAuxiliaryUnitChange(val, index)})">
              <el-option v-for="item in mateUnitList" :key="item.dictCode" :label="item.dictName" :value="item.dictCode">
              </el-option>
          </el-select>
        </el-form-item>
    ...
    <el-row>
      <el-col :span="12">
        <el-form-item label="物料炉号" prop="mateFurnaceNumber">
          <el-input v-model="dataForm.mateFurnaceNumber" placeholder="物料炉号"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="24">
        <el-form-item label="备注" size="mini" prop="mateNote">
