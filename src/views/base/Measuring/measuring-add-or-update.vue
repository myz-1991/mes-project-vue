    ...
    <el-row>
      <el-col :span="12">
        <el-form-item label="量具编码" prop="mateCode">
          <el-input v-model="dataForm.mateCode" placeholder="量具编码"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item label="量具名称" prop="mateName">
          <el-input v-model="dataForm.mateName" placeholder="量具名称"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
    ...
    <el-row>
      <el-col :span="12">
        <el-form-item label="量程" prop="mateFurnaceNumber">
          <el-input v-model="dataForm.mateFurnaceNumber" placeholder="量程"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    </el-form>
