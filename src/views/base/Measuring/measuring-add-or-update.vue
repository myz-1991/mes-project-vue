<template>
  <el-dialog :title="titleText" :close-on-click-modal="false" :visible.sync="visible">
    <el-form ref="dataForm" :model="dataForm" size="small" label-width="80px">
      <el-row>
        <el-col :span="12">
          <el-form-item label="量具编码" prop="mateCode">
            <el-input v-model="dataForm.mateCode" placeholder="量具编码" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="量具名称" prop="mateName">
            <el-input v-model="dataForm.mateName" placeholder="量具名称" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="量程" prop="mateFurnaceNumber">
            <el-input v-model="dataForm.mateFurnaceNumber" placeholder="量程" />
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
